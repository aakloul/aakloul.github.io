...
{
    var repo_name = "aakloul/privacy101";
    ...
    var api_comments_url = api_url + "/issues/" + comment_id + "/comments" + "?per_page=10&page=" + page_id;
    ...
    $(document).ready(function ()
    {
        ...
        $.ajax(api_comments_url, {
            ...
            success: function(comments, textStatus, jqXHR) {
                ...
                if (page_id == 1)
                    $("#gh-comments-list").append("<a href='" + url + "#new_comment_field' rel='nofollow'><span style='width: auto;' class='button'>Post a comment on Github</span></a>");
